				...
				<view class='item' v-for="(item,index) in addressList" :key="index">
					...
					<view class='operation acea-row row-between-wrapper'>
						...
						<view class='acea-row row-middle'>
							<view @click='editAddress(item.id)'><text class='iconfont icon-bianji'></text>{{$t(`biên tập`)}}
							</view>
							<view @click='delAddress(index)'><text class='iconfont icon-shanchu'></text>{{$t(`xóa bỏ`)}}
							</view>
						</view>
					</view>
				</view>
