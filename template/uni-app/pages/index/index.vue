...
export default {
  ...
  methods: {
    ...
    bindSortId(data) {
      ...
      } else if (["trang đầu", "trang chủ", "\u9996\u9875"].includes(((data.text && data.text.val) || "").toLowerCase())) {
        uni.switchTab({
    ...
    normalizeDiyText(value) {
      ...
      const dict = {
        ...
        "vui lòng nhập nút bên phải": "Vui lòng nhập nút bên phải",
        "vui lòng nhập chữ bên phải": "Vui lòng nhập chữ bên phải",
        "nhập từ khóa tìm kiếm": "Nhập từ khóa tìm kiếm",
        ...
        "tin tức": "Tin tức",
        "\u65b0\u95fb\u8d44\u8baf": "Tin tức",
        "nhận mã giảm giá": "Nhận mã giảm giá",
        "lịch sử xem": "Lịch sử xem",
        "cửa hàng điểm": "Cửa hàng điểm",
        "săn deal giá sốc": "Săn deal giá sốc",
        "giá từ 0đ": "Giá từ 0đ",
        "ghép nhóm tiết kiệm": "Ghép nhóm tiết kiệm",
        "điểm danh": "Điểm danh",
        "mã giảm giá": "Mã giảm giá",
        "danh sách bài viết": "Danh sách bài viết",
        "thông báo": "Thông báo",
        "nhóm điều hướng": "Nhóm điều hướng",
        "banner tìm kiếm": "Banner tìm kiếm",
        "điều hướng dưới": "Điều hướng dưới",
