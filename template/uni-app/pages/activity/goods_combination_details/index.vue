          ...
          <view class="bg-color">
            <view class="notice acea-row row-middle">
              <view class="num font-num">
                ...
                {{ $t(`Đã đánh vần rồi`) }}{{ pink_ok_sum }}{{ $t(`miếng`)
          ...
          <view class="assemble">
              ...
              <view class="right acea-row row-middle">
                <view>
                  <view class="lack"
                    ...
                    >{{ $t(`Mọi người thành lập một nhóm`) }}</view
                  >
                  <view class="time">
                    <count-down
                      :is-day="false"
            ...
            <template v-if="pink.length">
              <view class="more" @tap="showAll" v-if="pink.length > AllIndex"
                >{{ $t(`Xem thêm`) }}<text class="iconfont icon-xiangxia"></text
              ></view>
              <view
                class="more"
                @tap="hideAll"
                ...
                "
              >
                {{ $t(`đóng`) }}<text class="iconfont icon-xiangshang"></text>
              </view>
            </template>
          </view>
          <view class="playWay">
            <view class="title acea-row row-between-wrapper">
              <view>{{ $t(`Chơi theo nhóm`) }}</view>
            </view>
            <view class="way acea-row row-middle">
              <view class="item">
                <text class="num">①</text>
                <text>{{ $t(`Bắt đầu chuyến tham quan/tham gia chuyến tham quan`) }}</text>
              </view>
              <view class="iconfont icon-arrow"></view>
              <view class="item">
                <text class="num">②</text>
                <text>{{ $t(`Mời bạn bè`) }}</text>
              </view>
              <view class="iconfont icon-arrow"></view>
              <view class="item">
                <text class="num">③</text>
                <text>{{ $t(`Vận chuyển hết công suất`) }}</text>
              </view>
            </view>
          </view>
          <view class="playWay">
            <view class="title acea-row row-between-wrapper">
              <view>{{ $t(`Giới thiệu về chia sẻ nhóm`) }}</view>
            </view>
      ...
      >
        ...
        <view class="bnt acea-row">
          ...
          <view
            ...
            "
          >
            {{ $t(`Bắt đầu một nhóm ngay bây giờ`) }}
          </view>
          <view
              ...
              success() {
                uni.saveImageToPhotosAlbum({
                  ...
                  success: function (res) {
                    ...
                    that.$util.Tips({
                      title: this.$t(`Đã lưu thành công`),
                      icon: "success",
                    });
                  },
                  fail: function (res) {
                    that.$util.Tips({
                      title: this.$t(`Lưu không thành công`),
                    });
                  },
                });
              },
