...
<template>
	<base-drawer mode="bottom" :visible="isShow" background-color="transparent" mask maskClosable @close="closeDrawer">
		<view class="w-full bg--w111-fff rd-t-40rpx py-32">
			<view class="text-center fs-32 text--w111-333 fw-500 mb-34">{{ $t(`Bảo đảm dịch vụ`) }}</view>
			...
			<view class="mx-20 pb-safe">
				<view class="mt-52 h-72 flex-center rd-36px bg-color fs-26 text--w111-fff" @click="closeDrawer">{{ $t(`biết`) }}</view>
			</view>
		</view>
	</base-drawer>
</template>
