  ...
  <div>
    <div class="main">
      <el-card :bordered="false" shadow="never" class="ivu-mt mr20 card-tree">
        <div class="tree">
          <div class="main-btn">
            <el-button class="mb10" type="primary" v-db-click @click="clickMenu(4)" long>Thêm danh mục mới</el-button>
          </div>
          ...
          >
            ...
            <el-row :gutter="24">
              <el-col :span="24">
                ...
                <el-form-item label="Nội dung cuộc gọi：" prop="url">
                  <el-input
                    v-if="isEdit"
                    class="perW20"
                    type="text"
                ...
                <el-form-item label="Thông số yêu cầu：">
                  <vxe-table
                    resizable
                    show-overflow
                    keep-source
            ...
            <el-row :gutter="24">
              <el-col :span="24">
                ...
                <el-form-item label="Ví dụ về dữ liệu trả về：" prop="return_example">
                  <el-input
                    v-if="isEdit"
                    class="perW20"
                    type="textarea"
    ...
    <el-dialog :visible.sync="nameModal" width="470px" title="Tên nhóm" @on-ok="asyncOK">
  ...
  methods: {
    ...
    async handleSubmit() {
      if (!this.formValidate.name) {
        ...
        return this.$message.warning('Vui lòng nhập phương thức gọi');
      }
