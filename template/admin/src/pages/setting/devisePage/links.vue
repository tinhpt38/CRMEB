...
export default {
  ...
  destroyed() {
    // Phá hủy phiên bản Clipboard để tránh bị giám sát lại và tạo ra các lệnh gọi lại lặp đi lặp lại sau khi khởi tạo Clipboard trong các trang hoặc thành phần khác.
