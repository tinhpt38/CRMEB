<template>
  <div>
    <el-card :bordered="false" shadow="never" class="ivu-mb-16" :body-style="{ padding: 0 }">
      <div class="padding-add">
        <el-form
          ...
          inline
        >
          <el-form-item label="Tên điểm đón：">
    ...
    <el-card :bordered="false" shadow="never" class="ivu-mt">
      <el-button v-auth="['merchant-store_staff-create']" type="primary" v-db-click @click="add">Thêm người bảo lãnh</el-button>
      <el-table
        :data="storeLists"
        ref="table"
        class="mt14"
      ...
      >
        ...
        <el-table-column label="Tên người bảo lãnh" min-width="130">
          <template slot-scope="scope">
            <span>{{ scope.row.staff_name }}</span>
          </template>
        </el-table-column>
        <el-table-column label="Điểm đón" min-width="130">
          <template slot-scope="scope">
