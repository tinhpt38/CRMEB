  ...
  <el-card :bordered="false" shadow="never" class="ivu-mt">
    <div class="Modal">
      <div class="colLeft">
        ...
        <div class="conter">
          <el-button type="primary" @click="addLink">Thêm liên kết</el-button>
          <el-table
            :data="linkList"
            ref="couponTable"
            class="mt20"
          ...
          >
            ...
            <el-table-column label="H5liên kết" minWidth="170">
              <template slot-scope="scope">
            ...
            <el-table-column label="Thêm thời gian" minWidth="90">
              <template slot-scope="scope">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addLinkSubmit">Chắc chắn</el-button>
      </div>
    </el-dialog>
  </el-card>
</template>
