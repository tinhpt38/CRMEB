<template>
  ...
  <el-row :gutter="24">
    <el-col :span="24">
      <el-form-item :label="$t('message.productAdd.specType') + '：'" props="spec_type">
        <el-radio-group v-model="formValidate.spec_type" @input="changeSpec">
          <el-radio :label="0" class="radio">{{ $t('message.productAdd.singleSpec') }}</el-radio>
          <el-radio :label="1">{{ $t('message.productAdd.multiSpec') }}</el-radio>
        </el-radio-group>
        <el-dropdown v-if="formValidate.spec_type == 1" class="ml20" @command="confirm" trigger="hover">
          <span class="el-dropdown-link"> {{ $t('message.productAdd.selectSpecTemplate') }}<i class="el-icon-arrow-down el-icon--right"></i> </span>
    ...
    <el-col :span="24" v-if="formValidate.spec_type === 1" class="noForm">
      <el-form-item :label="$t('message.productAdd.productSpec') + '：'" prop="">
        <div class="specifications">
            ...
            >
              ...
              <div class="specifications-item-box">
                ...
                <div class="specifications-item-name mb18">
                  <el-input
                    v-model="item.value"
                    :placeholder="$t('message.productAdd.specName')"
                  ...
                  <el-checkbox
                    ...
                    >{{ $t('message.productAdd.addSpecImage') }}</el-checkbox
                  >
                  <el-tooltip
                    class="item"
                    effect="dark"
                    :content="$t('message.productAdd.addSpecImageTip')"
                    placement="right"
                  >
                  ...
                  >
                    <div v-for="(det, indexn) in item.detail" :key="indexn" class="mr10 spec drag">
                      ...
                      <el-input
                        style="width: 120px"
                        v-model="det.value"
                        :placeholder="$t('message.productAdd.specValue')"
                    ...
                    >
                      <el-input
                        :ref="'inputRef_' + index"
                        :placeholder="$t('message.productAdd.specValuePlaceholder')"
                      ...
                      <div class="addfont" slot="reference" type="text" v-db-click>{{ $t('message.productAdd.addSpecValue') }}</div>
                    </el-popover>
                  </draggable>
                </div>
              </div>
          ...
          <el-button v-if="attrs.length < 4" v-db-click @click="handleAddRole()">{{ $t('message.productAdd.addNewSpec') }}</el-button>
          <el-button v-if="attrs.length >= 1" type="text" v-db-click @click="handleSaveAsTemplate()"
            >{{ $t('message.productAdd.saveAsTemplate') }}</el-button
          >
        </div>
      </el-form-item>
    </el-col>
    <el-col :span="24" v-if="formValidate.spec_type === 1">
      <el-form-item :label="$t('message.productAdd.productAttributes') + '：'" class="labeltop" v-if="manyFormValidate.length">
        <VirtualScroll
                ...
                <template v-if="scope.$index == 0">
                  <template v-if="item.key">
                    <div v-if="attrs.length && attrs[scope.column.index] && manyFormValidate.length">
                      <el-select v-model="oneFormBatch[0][item.title]" :placeholder="`${$t('message.productCommon.pleaseSelect')}${item.title}`" clearable>
                        <el-option
                  ...
                  <template v-else-if="item.slot === 'action'">
                    <a v-db-click @click="batchAdd">{{ $t('message.productAdd.batchModify') }}</a>
                ...
                <template v-else>
                  ...
                  <template v-else-if="item.slot === 'action'">
                    <el-switch
                      ...
                      :active-text="$t('message.productAdd.show')"
                      :inactive-text="$t('message.productAdd.hide')"
                      :active-value="1"
                      :inactive-value="0"
    ...
    <div v-if="formValidate.spec_type === 0">
      <el-col :span="24">
        <el-form-item :label="$t('message.productAdd.image') + '：'">
      ...
      <el-col :span="24">
        <el-form-item :label="$t('message.productAdd.sellPrice') + '：'">
          <el-input-number
            :controls="false"
      ...
      <el-col :span="24">
        <el-form-item :label="$t('message.productAdd.costPrice') + '：'">
          <el-input-number
            :controls="false"
      ...
      <el-col :span="24">
        <el-form-item :label="$t('message.productAdd.otPrice') + '：'">
          <el-input-number
            :controls="false"
      ...
      <el-col :span="24">
        <el-form-item :label="$t('message.productAdd.stock') + '：'">
          <el-input-number
            :controls="false"
      ...
      <el-col :span="24">
        <el-form-item :label="$t('message.productAdd.productCode') + '：'">
          <el-input v-model.trim="oneFormValidate[0].bar_code" class="input_width"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">
        <el-form-item :label="$t('message.productAdd.barcode') + '：'">
      ...
      <el-col :span="24" v-if="formValidate.virtual_type == 0">
        <el-form-item :label="$t('message.productAdd.weight') + '：'">
          <el-input-number
            :controls="false"
      ...
      <el-col :span="24">
        <el-form-item :label="$t('message.productAdd.volume') + '：'" v-if="formValidate.virtual_type == 0">
          <el-input-number
            :controls="false"
      ...
      <el-col :span="24">
        <el-form-item
          :label="formValidate.virtual_type == 1 ? $t('message.productAdd.addCardOrCloudDisk') + '：' : $t('message.productAdd.selectCoupon') + '：'"
