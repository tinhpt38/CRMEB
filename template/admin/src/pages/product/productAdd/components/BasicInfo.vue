<template>
  ...
  <el-row :gutter="24">
    <el-col :span="24">
      <el-form-item :label="$t('message.productList.productType2')" props="is_virtual">
        <div
          class="virtual"
    ...
    <el-col :span="24">
      <el-form-item :label="$t('message.productList.productName3')" prop="store_name">
        <el-input
          class="content_width"
          v-model="formValidate.store_name"
          :placeholder="$t('message.productList.pleaseInputProductName3')"
          maxlength="80"
          show-word-limit
        />
      </el-form-item>
    ...
    <el-col :span="24">
      <el-form-item :label="$t('message.productList.unit3')" prop="unit_name">
        <el-input
          class="input_width"
          v-model="formValidate.unit_name"
          :placeholder="$t('message.productList.pleaseInputUnit2')"
          maxlength="5"
          show-word-limit
        />
      </el-form-item>
    ...
    <el-col :span="24">
      <el-form-item :label="$t('message.productList.productCarousel2')" prop="slider_image">
        <div class="acea-row">
          <div
            class="pictrue"
        ...
        <div class="tips-info">{{ $t('message.productList.sliderImageTip') }}</div>

        <!-- <div class="tips">(最多10张<br />750*750)</div> -->
      </el-form-item>
    </el-col>
    <el-col :span="24" id="selectvideo">
      <el-form-item :label="$t('message.productList.addVideo2')" prop="video_link">
        ...
        <div class="box-video-style" v-if="formValidate.video_link">
          <video style="width: 100%; height: 100%" :src="formValidate.video_link" controls="controls">
            {{ $t('message.productList.browserNotSupportVideo') }}
          </video>
          <div class="mark"></div>
        ...
        <div class="tips-info">{{ $t('message.productList.videoTip') }}</div>
      </el-form-item>
    </el-col>
    <el-col :span="24">
      <el-form-item :label="$t('message.productList.productCategory5')" prop="cate_id">
        <el-cascader
          class="content_width"
          ...
          clearable
        ></el-cascader>
        <span class="addfont" v-db-click @click="addCate">{{ $t('message.productList.addCategory2') }}</span>
      </el-form-item>
    </el-col>
    <el-col :span="24">
      <el-form-item :label="$t('message.productList.productLabel2')">
        <div class="flex">
          <useLabel
          ...
          ></useLabel>
          <el-button v-db-click @click="addGoodsTag">{{ $t('message.productList.selectLabel') }}</el-button>
        </div>
      </el-form-item>
    </el-col>
    <el-col :span="24">
      <el-form-item :label="$t('message.productList.productStatus')">
        <el-radio-group v-model="formValidate.is_show">
          <el-radio :label="1" class="radio">{{ $t('message.productList.putaway2') }}</el-radio>
          <el-radio :label="0">{{ $t('message.productList.offline2') }}</el-radio>
        </el-radio-group>
      </el-form-item>
    </el-col>
  </el-row>
