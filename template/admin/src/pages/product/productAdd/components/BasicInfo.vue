<template>
  ...
  <el-row :gutter="24">
    <el-col :span="24">
      <el-form-item label="Loại sản phẩm：" props="is_virtual">
        <div
          class="virtual"
    ...
    <el-col :span="24">
      <el-form-item label="Ảnh slider sản phẩm：" prop="slider_image">
        ...
        <div class="tips-info">Kích thước đề xuất: 800*800, bạn có thể kéo và thả để thay đổi thứ tự hình ảnh. Ảnh đầu tiên theo mặc định là ảnh chính và bạn có thể tải lên tối đa 10 ảnh.</div>

        <!-- <div class="tips">(Tối đa 10 ảnh<br />750*750)</div> -->
      </el-form-item>
    </el-col>
    ...
    <el-col :span="24">
      <el-form-item label="Danh mục sản phẩm：" prop="cate_id">
        <el-cascader
          ...
          clearable
        ></el-cascader>
        <span class="addfont" v-db-click @click="addCate">Thêm danh mục mới</span>
      </el-form-item>
    </el-col>
    <el-col :span="24">
      <el-form-item label="Nhãn sản phẩm：">
        <div class="flex">
          ...
          ></useLabel>
          <el-button v-db-click @click="addGoodsTag">Chọn nhãn</el-button>
        </div>
      </el-form-item>
    </el-col>
    <el-col :span="24">
      <el-form-item label="Tình trạng sản phẩm：">
        <el-radio-group v-model="formValidate.is_show">
          <el-radio :label="1" class="radio">Trên kệ</el-radio>
          <el-radio :label="0">Đã xóa khỏi kệ</el-radio>
        </el-radio-group>
      </el-form-item>
    </el-col>
  </el-row>
