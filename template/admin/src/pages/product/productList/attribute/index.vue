<template>
  <div>
    <el-dialog :visible.sync="val" :title="$t('message.productAttribute.title')" width="1000px" @closed="cancel">
      <div class="Modals">
        <el-form class="form" ref="form" label-width="70px" label-position="right">
          <el-row :gutter="24">
            <el-col :xl="24" :lg="24" :md="24" :sm="24" :xs="24">
              <el-form-item :label="$t('message.productAttribute.spec') + '：'" prop="store_name" label-for="store_name">
                <el-input
                  :placeholder="$t('message.productAttribute.spec')"
                  style="width: 10%"
                  class="input"
                  :value="item"
                ...
                <el-input :placeholder="$t('message.productAttribute.enter')" v-model="specsVal" style="width: 10%" class="input">
            ...
            <el-col :xl="24" :lg="24" :md="24" :sm="24" :xs="24">
              ...
              >
                ...
                <el-input :placeholder="$t('message.productAttribute.enter')" v-model="item.inputVal" style="width: 10%" class="input">
...
export default {
  ...
  methods: {
    ...
    confirm() {
      if (this.specsVal === '') {
        this.$message.error(this.$t('message.productAttribute.enterSpecName'));
      } else {
        ...
        if (this.specsVal !== '') {
          this.attrList.forEach((item) => {
            if (item.attrVal.length < 1) {
              this.$message.error(this.$t('message.productAttribute.enterSpecValue'));
            }
          });
        }
      }
