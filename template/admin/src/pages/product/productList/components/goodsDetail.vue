    ...
    <div class="goods_detail_wrapper" style="height: 640px">
      <HappyScroll size="5" resize hide-horizontal>
        <div style="width: 375px">
          <div class="title-box">{{ $t('message.pages.product.goodsDetail.title') }}</div>
          ...
          <div class="goods_info">
            ...
            <div class="msg">
              <div class="item">{{ $t('message.pages.product.goodsDetail.originalPrice') }}:￥{{ goodsInfo.productInfo.ot_price }}</div>
              <div class="item">{{ $t('message.pages.product.goodsDetail.stockLabel') }}:{{ goodsInfo.productInfo.stock }}{{ goodsInfo.productInfo.unit_name }}</div>
              <div class="item">
                {{ $t('message.pages.product.goodsDetail.salesLabel') }}:{{ goodsInfo.productInfo.sales + goodsInfo.productInfo.ficti
                }}{{ goodsInfo.productInfo.unit_name }}
              </div>
            </div>
          </div>
          <div class="con-box">
            <div class="title-box">{{ $t('message.pages.product.goodsDetail.introTitle') }}</div>
