  ...
  <div class="article-manager">
      ...
      <div class="padding-add">
        ...
        >
          ...
          <el-form-item label="Xem lại trạng thái：">
            ...
            >
              <el-option value="1" label="đã trả lời"></el-option>
          ...
          <el-form-item label="Xem lại trạng thái：">
            <el-select
              ...
              class="form_content_width"
            >
              <el-option value="0" label="Chưa được xem xét"></el-option>
              <el-option value="1" label="Đi qua"></el-option>
              <el-option value="2" label="Vật bị loại bỏ"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="Thông tin sản phẩm：" label-for="store_name">
            <el-input
              placeholder="Vui lòng nhập thông tin sản phẩm"
              clearable
    ...
    <el-card :bordered="false" shadow="never" class="ivu-mt mt16">
      ...
      >
        ...
        <el-table-column label="Bình luậnID" width="80">
          <template slot-scope="scope">
            <span>{{ scope.row.id }}</span>
          </template>
        </el-table-column>
        <el-table-column label="Thông tin sản phẩm" min-width="130">
          <template slot-scope="scope">
        ...
        <el-table-column label="Đặc điểm kỹ thuật" min-width="130">
          <template slot-scope="scope">
        ...
        <el-table-column label="Thời gian đánh giá" min-width="130">
          <template slot-scope="scope">
    ...
    <el-dialog :visible.sync="modals" scrollable title="Trả lời nội dung" width="720px">
      <el-form ref="contents" :model="contents" :rules="ruleInline" label-position="right" @submit.native.prevent>
        <el-form-item prop="content">
          <el-input v-model="contents.content" type="textarea" :rows="4" placeholder="Vui lòng nhập nội dung trả lời" />
        </el-form-item>
      </el-form>
      <div slot="footer">
    ...
    <el-dialog :visible.sync="attrModal" title="Chọn thông số kỹ thuật sản phẩm" width="1000px">
      <el-table ref="table" :row-key="getRowKey" :data="goodsData.attrs" height="500">
        ...
        <el-table-column label="Giá đặc biệt" min-width="120">
          <template slot-scope="scope">
    ...
    <el-dialog :visible.sync="pictureModal" width="950px" title="Tải lên hình ảnh sản phẩm" :close-on-click-modal="false">
      <uploadPictures
        :isChoice="isChoice"
        @getPic="getPic"
        @getPicD="getPicD"
...
export default {
  ...
  data() {
    return {
      ...
      goodsModal: false,
      batchModal: false,
      attrModal: false, // Chọn thông số kỹ thuật sản phẩm
      batchFormData: {
        status: 1,
      },
      grid: {
      ...
      ruleInline: {
        content: [{ required: true, message: 'Vui lòng nhập nội dung trả lời', trigger: 'blur' }],
      },
      rows: {},
      ids: [],
    };
  ...
  methods: {
    ...
    openBatchModal() {
      if (!this.ids.length) return this.$message.warning('Vui lòng chọn một bình luận trước');
