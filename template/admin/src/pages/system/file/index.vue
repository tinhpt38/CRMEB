  ...
  <div>
    <el-card :bordered="false" shadow="never" class="ivu-mt">
      <el-tabs class="p-x-20" v-model="fileType">
        <el-tab-pane name="img" :label="$t('message.systemGeneral.imageManagement')"></el-tab-pane>
        <el-tab-pane name="video" :label="$t('message.systemGeneral.videoManagement')"></el-tab-pane>
      </el-tabs>
