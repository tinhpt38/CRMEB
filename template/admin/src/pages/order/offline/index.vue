<template>
  <div>
    ...
    <el-card :bordered="false" shadow="never" class="ivu-mt mt16">
      <el-button type="primary" v-db-click @click="qrcodeShow">Xem mã QR thanh toán</el-button>
      <el-table
        :data="tbody"
        ref="table"
        class="mt14"
      ...
      >
        ...
        <el-table-column label="Thông tin người dùng" min-width="180">
          <template slot-scope="scope">
        ...
        <el-table-column label="Giá đặc biệt" min-width="180">
          <template slot-scope="scope">
    ...
    <el-dialog :visible.sync="modal" title="Mã thanh toán" width="540px">
...
export default {
  data() {
    return {
      ...
      loading: false,
      total: 0,
      animal: 0, // Ẩn đường viền trang trí
      pagination: {
        page: 1,
        limit: 30,
        order_id: '',
