<template>
  <el-dialog :visible.sync="modals" :title="$t('message.orderList.pleaseEditContent')" class="order_box" :show-close="true" width="540px">
    <el-form
      ref="formValidate"
      :model="formValidate"
      :rules="ruleValidate"
    ...
    >
      <el-form-item :label="$t('message.orderList.remark')" prop="remark">
        <el-input
          ...
          show-word-limit
          type="textarea"
          :placeholder="$t('message.orderList.orderRemark')"
          style="width: 414px"
        />
      </el-form-item>
    </el-form>
