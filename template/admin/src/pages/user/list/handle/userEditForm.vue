<template>
  <div class="user-info">
    <el-form ref="formItem" :rules="ruleValidate" :model="formItem" label-width="100px" @submit.native.prevent>
      <div class="section">
        ...
        <div class="section-bd">
          <div class="item">
            <el-form-item :label="$t('userList.userId') + '：'">
              <el-input class="form-sty" disabled v-model="formItem.uid" :placeholder="$t('userEditForm.pleaseInputNumber')"></el-input>
            </el-form-item>
          </div>
          <div class="item">
            <el-form-item :label="$t('userList.realName') + '：'" prop="real_name">
              <el-input class="form-sty" v-model.trim="formItem.real_name" :placeholder="$t('userEditForm.pleaseInputRealName')"></el-input>
            </el-form-item>
          </div>
          <div class="item">
            <el-form-item :label="$t('userList.mobile') + '：'" prop="phone">
              <el-input class="form-sty" v-model="formItem.phone" :placeholder="$t('userEditForm.pleaseInputMobile')"></el-input>
            </el-form-item>
          </div>
          <div class="item">
          ...
          <div class="item">
            <el-form-item :label="$t('userList.idCardNo') + '：'">
              <el-input class="form-sty" v-model.trim="formItem.card_id" :placeholder="$t('userEditForm.pleaseInputIdCardNo')"></el-input>
            </el-form-item>
          </div>
          <div class="item">
            <el-form-item :label="$t('userList.userAddress') + '：'">
              <el-input class="form-sty" v-model="formItem.addres" :placeholder="$t('userEditForm.pleaseInputUserAddress')"></el-input>
            </el-form-item>
          </div>
        </div>
      </div>
      ...
      <div class="section">
        ...
        <div class="section-bd">
          ...
          <div class="item lang" v-if="formItem.spread_open == 1">
            <el-form-item :label="$t('userEditForm.distributionPermission') + '：'">
          ...
          <div class="item">
            <el-form-item :label="$t('userList.userRemark') + '：'">
              <el-input
                ...
                :placeholder="$t('userEditForm.pleaseInputUserRemark')"
              ></el-input>
            </el-form-item>
          </div>
        </div>
    ...
    <el-dialog :visible.sync="labelShow" append-to-body :title="$t('userList.selectUserTags')" :show-close="true" width="540px">
