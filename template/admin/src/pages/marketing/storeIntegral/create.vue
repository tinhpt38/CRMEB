        ...
        <el-col :span="23">
          ...
          >
            ...
            <el-col v-show="current === 1">
              <el-col :span="24">
                <el-form-item prop="image">
                  <div class="custom-label" slot="label">
                    <div>
                      <div>Hình ảnh chính của sản phẩm</div>
                      <div>(750*750)</div>
                    </div>
                    <div>：</div>
                  </div>
              ...
              <el-col :span="24">
                <el-form-item label="Giới hạn số lượng quy đổi của người dùng：" prop="num">
                  <div class="acea-row row-middle">
                    ...
                    />
                    <div class="ml10 grey">
                      Có giới hạn về tổng số mặt hàng mà mỗi người dùng có thể mua. Ví dụ: đặt thành 4, cho biết hoạt động này,Mỗi người dùng có thể đổi tổng cộng tối đa 4 vật phẩm
                    </div>
                  </div>
                </el-form-item>
              </el-col>
...
export default {
  ...
  data() {
    return {
      ...
      stepList: ['Chọn sản phẩm tích điểm', 'Điền thông tin cơ bản', 'Sửa đổi chi tiết sản phẩm'],
      modals: false,
      modal_loading: false,
      images: [],
      formValidate: {
        ...
        num: [
          {
            required: true,
            type: 'number',
            message: 'Vui lòng nhập giới hạn số lượng quy đổi',
            trigger: 'blur',
          },
        ],
        once_num: [
          {
            required: true,
            type: 'number',
            message: 'Vui lòng nhập giới hạn số lượng quy đổi một lần',
            trigger: 'blur',
          },
        ],
      },
            ...
            if (!that.formValidate.attrs) {
              ...
              for (let index in that.formValidate.attrs) {
                if (that.formValidate.attrs[index].quota <= 0) {
                  return that.$message.error('Số lần quy đổi phải lớn hơn0');
                }
              }
            }
            this.current += 1;
