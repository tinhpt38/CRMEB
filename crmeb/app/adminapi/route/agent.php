...
Route::group('agent', function () {
    ...
    Route::group(function () {
        ...
        Route::put('spread', 'v1.agent.AgentManage/editSpread')->option(['real_name' => 'Sửa đổi trình quảng bá ưu việt']);
        //Thống kê đầu
        ...
        Route::get('stair', 'v1.agent.AgentManage/get_stair_list')->option(['real_name' => 'Danh sách nhà quảng bá']);
        ...
        Route::put('stair/delete_system_spread/:uid', 'v1.agent.AgentManage/delete_system_spread')->option(['real_name' => 'Bị loại khỏi chương trình khuyến mãi']);
    ...
    })->option(['parent' => 'agent', 'cate_name' => 'Quản lý nhà phân phối']);
    ...
    })->option(['parent' => 'agent', 'cate_name' => 'Cài đặt phân phối']);
    ...
    })->option(['parent' => 'agent', 'cate_name' => 'Cấp độ phân phối']);
    ...
    })->option(['parent' => 'agent', 'cate_name' => 'Ứng dụng phân phối']);
