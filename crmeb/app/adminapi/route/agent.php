 ...
 */Route::group('agent', function () {
    ...
    /** Quản lý Affiliate */    Route::group(function () {
    ...
    /** Cài đặt Affiliate */    Route::group(function () {
    ...
    /** Cấp bậc Affiliate */    Route::group(function () {
    ...
    /** Đơn vị kinh doanh */    Route::group(function () {
    ...
    /** Đăng ký làm Affiliate */    Route::group(function () {
