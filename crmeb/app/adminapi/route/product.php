...
Route::group('product', function () {
    ...
    /** Danh mục sản phẩm */    Route::group(function () {
        ...
        Route::get('category/create', 'v1.product.StoreCategory/create')->option(['real_name' => 'Lấy form thêm danh mục sản phẩm']);
        ...
        Route::put('category/:id', 'v1.product.StoreCategory/update')->option(['real_name' => 'Cập nhật danh mục sản phẩm']);
        ...
        Route::put('category/set_show/:id/:is_show', 'v1.product.StoreCategory/set_show')->option(['real_name' => 'Cập nhật trạng thái danh mục sản phẩm']);
    ...
    /** sản phẩm */    Route::group(function () {
        ...
        Route::get('product/type_header', 'v1.product.StoreProduct/type_header')->option(['real_name' => 'Lấy cấu hình cột danh sách sản phẩm']);
        //Sửa đổi trạng thái sản phẩm
        Route::put('product/set_show/:id/:is_show', 'v1.product.StoreProduct/set_show')->option(['real_name' => 'Cập nhật trạng thái sản phẩm']);
...
//        Route::put('product/set_product/:id', 'v1.product.StoreProduct/set_product')->option(['real_name' => 'Chỉnh sửa nhanh sản phẩm']);
        ...
        Route::post('product/rule/:id', 'v1.product.StoreProductRule/save')->option(['real_name' => 'Lưu quy tắc sản phẩm']);
        //Chi tiết quy tắc
        ...
        Route::get('product/get_rule', 'v1.product.StoreProduct/get_rule')->option(['real_name' => 'Lấy mẫu thuộc tính quy tắc sản phẩm']);
        //Nhận mẫu vận chuyển
        Route::get('product/get_template', 'v1.product.StoreProduct/get_template')->option(['real_name' => 'Lấy mẫu vận chuyển']);
        ...
        //Lưu mới hoặc Lưu
        Route::post('product/:id', 'v1.product.StoreProduct/save')->option(['real_name' => 'Lưu sản phẩm']);
        //Tạo thuộc tính
    ...
    /** Nhãn sản phẩm */    Route::group(function () {
        ...
        Route::put('label/status/:id/:status', 'v1.product.StoreProductLabel/labelStatus')->option(['real_name' => 'Cập nhật trạng thái nhãn sản phẩm']);
        Route::put('label/is_show/:id/:is_show', 'v1.product.StoreProductLabel/labelIsShow')->option(['real_name' => 'Cập nhật hiển thị nhãn sản phẩm']);
    ...
    /** Bảo hành sản phẩm */    Route::group(function () {
        ...
        Route::post('protection/save/:id', 'v1.product.StoreProductProtection/protectionSave')->option(['real_name' => 'Lưu mục bảo vệ sản phẩm']);
        Route::put('protection/status/:id/:status', 'v1.product.StoreProductProtection/protectionStatus')->option(['real_name' => 'Cập nhật trạng thái mục bảo vệ sản phẩm']);
        Route::delete('protection/del/:id', 'v1.product.StoreProductProtection/protectionDel')->option(['real_name' => 'Xóa mục bảo vệ sản phẩm']);
    })->option(['parent' => 'product', 'cate_name' => 'Mục bảo vệ sản phẩm']);
