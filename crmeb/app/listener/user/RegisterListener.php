 ...
 */class RegisterListener implements ListenerInterface
{
     ...
     */    public function handle($event): void
    {
        ...
        if ($spreadUid) {
            ...
            /** @var UserSpreadServices $userSpreadServices */            $userSpreadServices = app()->make(UserSpreadServices::class);
            $res = $userSpreadServices->setSpread($uid, $spreadUid);

            //Liên kết Khách hàng cấp dưới thông báo tùy chỉnh thành công
            if ($res) {
        ...
        if ($isNew) {
            //Tặng mã giảm giá cho người mới
