 ...
 */class StoreBargainServices extends BaseServices
{
     ...
     */    public function getStoreBargainList(array $where)
    {
        ...
        /** @var StoreBargainUserServices $storeBargainUserServices */        $storeBargainUserServices = app()->make(StoreBargainUserServices::class);
        ...
        /** @var StoreBargainUserHelpServices $storeBargainUserHelpServices */        $storeBargainUserHelpServices = app()->make(StoreBargainUserHelpServices::class);
...
//    /**
//     * TODO Nhận mức giá mà Khách hàng có thể cắt giảm
//     * @param $id $id Số bảng thương lượng sự tham gia của Khách hàng
//     * @return float
//     * @throws \think\db\exception\DataNotFoundException
//     * @throws \think\db\exception\ModelNotFoundException
...
//    /**
//     * TODO Nhận được mức giá giảm bởi Khách hàng
//     * @param int $id $id Số bảng thương lượng sự tham gia của Khách hàng
//     * @return float
//     */
...
//    }
    ...
    {
        /** @var StoreBargainUserServices $bargainUserServices */        $bargainUserServices = app()->make(StoreBargainUserServices::class);
     ...
     */    public function setHelpBargain(int $uid, int $bargainId, int $bargainUserUid)
    {
        ...
        if (!$bargainInfo) throw new ApiException('Cuộc thương lượng đã kết thúc');
        $bargainInfo = $bargainInfo->toArray();
        /** @var StoreBargainUserHelpServices $userHelpService */        $userHelpService = app()->make(StoreBargainUserHelpServices::class);
        /** @var StoreBargainUserServices $bargainUserService */        $bargainUserService = app()->make(StoreBargainUserServices::class);
     ...
     */    public function decBargainStock(int $num, int $bargainId, string $unique)
    {
        ...
        if ($unique) {
            ...
            //Trừ đi hàng tồn kho và doanh thu của các Sản phẩm trả giá
     ...
     */    public function poster($bargainId, $user, $from)
    {
        ...
        /** @var StoreBargainUserServices $services */        $services = app()->make(StoreBargainUserServices::class);
        $bargainUser = $services->get(['bargain_id' => $bargainId, 'uid' => $user['uid']], ['price', 'bargain_price_min']);
        if (!$bargainUser) {
            throw new ApiException('Không tìm thấy thông tin thương lượng của Khách hàng');
        }
        try {
