...
<body>
    <div class="wrap" id="step4">
        ...
        <section class="section">
            ...
            <div class="bottom tac"><a href="javascript:;" class="btn_old mid"><img class="shuaxin"
                        src="./images/install/shuaxin.png" align="absmiddle" />&nbsp;正在安装...</a></div>
        </section>
